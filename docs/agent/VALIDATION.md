...
(only CI badge queries and the exact live main-commit Health/Smoke image URLs may change),
...
live main-commit Health/Smoke image URLs. It rejects static passing replacements, forced Health colors,
