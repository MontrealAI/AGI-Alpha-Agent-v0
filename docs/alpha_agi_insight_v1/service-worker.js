...
This is generally NOT safe. Learn more at https://bit.ly/wb-precache`;
  ...
  registerRoute(
    ({ request, url }) => request.destination === "script" || request.destination === "worker" || request.destination === "font" || url.pathname.endsWith(".wasm") || url.pathname.includes("/assets/local-llm/models/") && url.pathname.endsWith(".onnx") || url.pathname.includes("/ipfs/") && url.pathname.endsWith(".json"),
  ...
  self.addEventListener("activate", (event) => {
    event.waitUntil(caches.keys().then((names) => Promise.all(
      names.filter((name) => name.startsWith("alpha-insight-") && !name.startsWith(CACHE_PREFIX)).map((name) => caches.delete(name))
    )));
  });
})();
