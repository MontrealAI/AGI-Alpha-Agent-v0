...
# Large‑Scale α‑AGI Business 👁️✨ (https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/alpha_agi_business_2_v1/$AGIALPHA) Demo – **“Infinite Bloom 3.0”**
...
# (https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/alpha_agi_business_2_v1/offline‑first – no API key required, automatically upgrades if $OPENAI_API_KEY is present)
```
...
flowchart LR
  subgraph Alpha_AGI_Business
    direction TB
    MA[📊 MarketAnalysisAgent] --> O(https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/alpha_agi_business_2_v1/Orchestrator)
    ST[🧠 StrategyAgent] --> O
    RE[🔍 ResearchAgent] --> O
    CG[🛠️ CodeGenAgent] --> O
    PL[🧮 PlanningAgent] --> O
    SA[🛡️ SafetyAgent] --> O
    ME[💾 MemoryAgent] --> O
    O -->|alpha insights| B(https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/alpha_agi_business_2_v1/("α-AGI Business<br/>(*.alpha.agi.eth)"))
  end
  B -->|$AGIALPHA rewards| Users(https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/alpha_agi_business_2_v1/(Stake‑holders))
```

*The orchestrator natively speaks **A2A** & **OpenAI Agents SDK**.
If no external key is detected it seamlessly switches to local Llama‑3 GGUF weights (https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/alpha_agi_business_2_v1/no outbound traffic).*
...
|--------|----------------|----------|------------------|----------------------|
| **α‑AGI Business** | `<sub>.alpha.agi.eth` | Wallet holds **$AGIALPHA** & bounties | Defines **Problem Portfolios** (https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/alpha_agi_business_2_v1/α‑jobs), pools data/rights, sets domain constraints | Aggregates high‑value problems, captures upside from solved portfolios, reinvests in new quests |
| **α‑AGI Agent** | `<sub>.alpha.agent.agi.eth` | Personal stake (https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/alpha_agi_business_2_v1/reputation + escrow) | Detects, plans & executes α‑jobs issued by any Business | Earns **$AGIALPHA** rewards, grows reputation, evolves reusable alpha recipes |
...
> **On-chain** as `<name>.alpha.agi.eth`, an *α-AGI Business* 👁️✨ unleashes a self-improving *α-AGI Agent* 👁️✨ (https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/alpha_agi_business_2_v1/`<name>.alpha.agent.agi.eth`) swarm to hunt inefficiencies and transmute them into **$AGIALPHA**.
...
## 🤖 Featured Agents (https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/alpha_agi_business_2_v1/this demo)
...
*Detected by MarketAnalysisAgent during CI run (https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/alpha_agi_business_2_v1/UTC‑now):*  

> **Cross‑venue ETH‑stETH basis = 38 bp (https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/alpha_agi_business_2_v1/2 σ)**  → **delta‑neutral carry trade.**

**Action Plan (https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/alpha_agi_business_2_v1/autonomous):**

1. `buy stETH` on Curve (https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/alpha_agi_business_2_v1/0 bp fee via Negotiator rebate)  
2. `short ETH‑PERP` on dYdX (https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/alpha_agi_business_2_v1/funding –22 bp)  
3. Hedge drift via 4‑hourly re‑balancer  
4. Net yield ≈ 5.9 % APR, chain‑audited every epoch  

*(https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/alpha_agi_business_2_v1/Full agent transcript in dashboard → Alpha tab)*
...
| Scenario | Command |
|----------|---------|
| **Laptop (https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/alpha_agi_business_2_v1/online)** | `docker run -e OPENAI_API_KEY=$OPENAI_API_KEY -p 7860:7860 ghcr.io/montrealai/alpha-asi:latest` |
| **Air‑gapped / offline** | `docker run --env OFFLINE=1 -p 7860:7860 ghcr.io/montrealai/alpha-asi:latest` |
| **GPU cluster (https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/alpha_agi_business_2_v1/Helm)** | `helm repo add montrealai https://ghcr.io/montrealai/charts && helm install agialpha montrealai/alpha-asi` |
...
## 💎 Tokenomics (https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/alpha_agi_business_2_v1/excerpt)

| Parameter | Value | Purpose |
|-----------|-------|---------|
| Supply | **1 B `$AGIALPHA`** (https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/alpha_agi_business_2_v1/fixed) | Aligns Agents ↔ Businesses ↔ Users |
...
* **2026+** — Regional blooms (https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/alpha_agi_business_2_v1/APAC, LATAM) & VR garden shows  

---

## 🖥️ Dev & Ops

* GitHub Actions matrix (https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/alpha_agi_business_2_v1/CPU / CUDA / ROCm) – build + test < 18 min  
* Signed container (https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/alpha_agi_business_2_v1/`cosign` + `in‑toto`) – SLSA‑3 provenance  
