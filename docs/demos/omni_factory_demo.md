...
**Scope:** Simplified numeric city model, not a Unity digital twin. Local ledger entries are not on-chain AGIALPHA.
...
[![Colab](https://img.shields.io/badge/Try-on-Colab-yellow?logo=googlecolab)](https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/omni_factory_demo/colab_omni_factory_demo.ipynb)
Run the full demo interactively in [Google Colab](https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/omni_factory_demo/colab_omni_factory_demo.ipynb).
...
See [docs/OFFLINE_SETUP.md](https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/docs/OFFLINE_SETUP.md) for more details.
...
provided [`plugins/example_agent_plugin.py`](https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/omni_factory_demo/plugins/example_agent_plugin.py)
...
[View README on GitHub](https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/omni_factory_demo/README.md)
