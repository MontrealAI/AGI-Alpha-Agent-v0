...
exit code, annotations, artifacts, logs, and optional JUnit XML path. The
bundle is now generated by `repo_healer_v1/ci_ingest.py` instead of ad hoc
log scraping in the workflow file.
