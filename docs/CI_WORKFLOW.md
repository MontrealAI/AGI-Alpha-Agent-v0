...
On tags/manual dispatch it expands to the full release matrix (dual-version lint/type/test, insight-browser eslint, Windows/macOS smoke, docs build validation, Docker/signing/deploy path checks).
