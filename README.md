...
|3|`alpha_agi_business_2_v1`|🏗|Marketing + sales agent swarm.|Validates cross-channel growth loops.|`./alpha_factory_v1/demos/alpha_agi_business_2_v1/run_business_2_demo.sh`|
...
|8|`era_of_experience`|🏛|Lifelong RL playground with grounded rewards.|Showcases self-improving agent loops.|`./alpha_factory_v1/demos/era_of_experience/run_experience_demo.sh`|
...
|11|`muzero_planning`|♟|MuZero++ planning playground.|Test search-based reasoning loops.|`./alpha_factory_v1/demos/muzero_planning/run_muzero_demo.sh`|
