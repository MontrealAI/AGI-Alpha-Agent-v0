...
def _resolve_get_agent() -> Callable[[str], Any]:
    ...
    get_agent = getattr(agents_module, "get_agent", None)
    if get_agent is None:
        get_agent = importlib.import_module("backend.agents.registry").get_agent
    return get_agent
...
class AgentRunner:
    ...
    def __init__(
        ...
        self.name = name
        self.inst = inst or _resolve_get_agent()(name)
