...
|12|`self_healing_repo`|🩹|Repo-Healer v1 runs bounded triage + deterministic Tier-1 repairs for this repo.|Maintains pipeline uptime alpha.|`docker compose -f alpha_factory_v1/demos/self_healing_repo/docker-compose.selfheal.yml up`|
