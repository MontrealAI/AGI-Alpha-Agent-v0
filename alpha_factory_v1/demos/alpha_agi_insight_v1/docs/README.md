[See docs/DISCLAIMER_SNIPPET.md](https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/docs/DISCLAIMER_SNIPPET.md)
...
Start the Insight demo with the repository quickstart guide
...
[colab_alpha_agi_insight_v1.ipynb](https://github.com/MontrealAI/AGI-Alpha-Agent-v0/blob/main/alpha_factory_v1/demos/alpha_agi_insight_v1/colab_alpha_agi_insight_v1.ipynb).
